...
export default function DOAuthPage() {
  ...
  useEffect(() => {
    ...
    const fetchServiceInfo = async () => {
      ...
      try {
        ...
        console.log('serviceInfoData', serviceInfoData)
  ...
  const handleAuthorize = async () => {
    ...
    setLoading(true)
    setError(null)
    setStatus('Creating authorization grant...')
    ...
    try {
      ...
      // Convert resource IDs to proper format (vector<ID>)
      // In Sui, object IDs are passed as addresses in pure arguments
